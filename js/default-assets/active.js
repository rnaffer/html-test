(function ($) {
    ...
    $("#reservationsScroll").on('click', function () {
        $('html, body').animate({
            scrollTop: $("#reservations").offset().top - 75
        }, 800);
    });

    $("#speakersScroll").on('click', function () {
        $('html, body').animate({
            scrollTop: $("#speakers").offset().top - 75
        }, 800);
    });

    $("#agendaScroll").on('click', function () {
        $('html, body').animate({
            scrollTop: $("#agenda").offset().top - 75
        }, 800);
    });
    ...
    // ****************************
    if ($.fn.countdown) {
        $("#clock").countdown("2020/01/27", function (event) {
